...
func generateChallenge(kind string, slideCapt slide.Captcha, rotCapt rotate.Captcha) (*challengePayload, error) {
	switch kind {
	case "rotate":
		...
		return &challengePayload{
			kind: antibot.KindRotate, answer: answer, public: data.GetPublicData(),
			master: master, thumb: thumb, tileKey: "thumb",
		}, nil
	default:
		...
		return &challengePayload{
			kind: antibot.KindSlide, answer: answer, public: data.GetPublicData(),
			master: master, thumb: thumb, tileKey: "tile",
		}, nil
	}
}
